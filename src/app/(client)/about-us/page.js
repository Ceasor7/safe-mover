...
const AboutUs = () => {
  return (
    <div className="my-5">
      <h1 className="text-4xl mt-5 mx-auto max-w-6xl text-gray-400 font-bold mb-3">
        Best Car Movers in Nairobi, Kenya
      </h1>
      <div className="flex flex-col sm:flex-row my-14 gap-x-28 mx-auto max-w-6xl">
      ...
      <div className="my-14">
        <h1 className="font-bold text-5xl text-gray-700 mx-auto max-w-6xl my-3">
          Our History
        </h1>
        <p className="font-bold text-gray-700 mx-auto max-w-6xl my-3">
      ...
      <hr className="border-black mx-auto max-w-6xl" />
      <div className="my-14">
        <OurCulture />
      </div>
      <hr className="border-black mx-auto max-w-6xl" />
      <div className="my-14">
        <h1 className="text-2xl sm:text-4xl text-[#00008B] font-bold mx-auto max-w-6xl">
          Our Team
        </h1>
        <hr className="border-black my-3 mx-auto max-w-6xl" />
        <OurTeam />
      </div>
    </div>
  );
